...
public class SalaryInformation {
	...
	private String Monthly_Money_Currency;
	...
	private String Weekly_Money_Currency;
	...
	public String getMonthly_Money_Currency() {
		return Monthly_Money_Currency;
	}

	public void setMonthly_Money_Currency(String monthly_Money_Currency) {
	...
	public String getWeekly_Money_Currency() {
		return Weekly_Money_Currency;
	}

	public void setWeekly_Money_Currency(String weekly_Money_Currency) {
